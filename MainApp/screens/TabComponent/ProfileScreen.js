            ...
            <View style={{ flex: 1, backgroundColor: Theme.bgcolor }}>
                <ScrollView>
                    ...
                    <LinearGradient colors={['#fc0f84', '#020cab']}
                        ...
                        <Text style={styles.myAc}>My Account</Text>
                            <View style={styles.balancesty}>
                                ...
                                <Text style={styles.coststy}>$1200 </Text>
                            </View>
                    </LinearGradient>
                    ...
                    <View style={styles.tablistContainer}>
                        ...
                        <TouchableOpacity style={styles.tabBox} onPress={() => this.props.navigation.navigate("Reward")}>
                            <View style={styles.tabIconSty}>
                                <Icon family="AntDesign" name="gift" size={25} color="#FFF" />
                            </View>
                            <Text style={styles.tabName}>Rewards</Text>
                        </TouchableOpacity>
                    ...
                    <View>
                        ...
                        <View style={{ paddingLeft: 35, paddingVertical: 10, }}>
                            <TouchableOpacity onPress={() => this.props.navigation.navigate("AccountEdit")}>
                                <View style={styles.settingLayout}>
                                    <View style={styles.settingNamesty}>
                                        <Icon family="AntDesign" name='solution1' size={30} color={Theme.mainColor} />
                                        <Text style={styles.meunSty}>Account Details</Text>
                                    </View>
                                    <Icon family="MaterialIcons" name="keyboard-arrow-right" size={30} color="black" />
                                </View>
                            </TouchableOpacity>
